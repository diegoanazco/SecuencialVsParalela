...
public class Binary_search_paralelo extends Thread {
	...
	public Binary_search_paralelo(int[] array, int startindex, int endindex, int key) {
		super();
		this.array = array;
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		for(int i = 0; i < pruebas.length; i++)
		{
			...
			ArrayList<Binary_search_paralelo> hilos = new ArrayList<Binary_search_paralelo>();

			
			for(int k = 0; k < 4; k++)
			{
				hilos.add(new Binary_search_paralelo(arr, k * (n/4), (k + 1 ) * (n / 4), x));
			}
